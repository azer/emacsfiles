(defun color-theme-azer ()
  ...
  (color-theme-install
   '(color-theme-azer
     ...
     (font-lock-builtin-face ((t (:foreground "#ffee33"))))
     (font-lock-comment-face ((t (:foreground "#666666"))))
     (font-lock-constant-face ((t (:foreground "#ff4030" :weight bold :bold t))))
     (font-lock-doc-face ((t (:foreground "#666666"))))
     (font-lock-function-name-face ((t (:foreground "#88ffff" :weight bold :bold t))))
     (font-lock-keyword-face ((t (:foreground "#33ff55" :weight bold :bold t))))
     (font-lock-string-face ((t (:foreground "#ff4030"))))
     (font-lock-type-face ((t (:foreground "#ffff33" :bold t :weight bold))))
     (font-lock-variable-name-face ((t (:foreground "#ffffff" :weight bold :bold t))))
     ...
     (menu ((t (nil))))
     (mode-line ((t (:foreground "White" :background "#111111" :box (:line-width -1 :style released-button)))))
